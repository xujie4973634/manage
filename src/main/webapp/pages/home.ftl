...
<head>
    ...
    <link href="${ctx!}/web-static/assets/fonts/font-awesome.css" rel="stylesheet" type="text/css">
    <link href="${ctx!}/web-static/assets/fonts/elegant-fonts.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet">
    <link rel="stylesheet" href="${ctx!}/web-static/assets/bootstrap/css/bootstrap.css" type="text/css">
    <link rel="stylesheet" href="${ctx!}/web-static/assets/css/magnific-popup.css" type="text/css">
    <link rel="stylesheet" href="${ctx!}/web-static/assets/css/style.css" type="text/css">
...
<div class="page-wrapper">
    <header>
        <div class="brand animate"><a href="http://www.hmaikj.com"><img src="${ctx!}/web-static/assets/img/logo.png" alt=""></a></div>
        <nav>
            <ul class="navigation animate">
                <li><a href="${ctx!}/login/loginPage"  data-target="#modal-about-us">Login</a></li>
                <li><a href=""  data-target="#modal-our-works">customer management</a></li>
    ...
    <div class="content-wrapper">
        <div class="content-main animate">
            <div class="container">
                <h1 class="font-size-90">禾麦 集团 !</h1>
                <h2 class="opacity-60">Standing Grain Wheat Group Company</h2>
            </div>
            <!--end container-->
        </div>
        <!--end content-main-->
                            ...
                            <section>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="person">
                                            <div class="image">
                                                <div class="bg-transfer"><img src="${ctx!}/web-static/assets/img/person-01.jpg" alt=""></div>
                                            </div>
                                            <h4>Jane Doe</h4>
                                            <h5>Company CEO</h5>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="person">
                                            <div class="image">
                                                <div class="bg-transfer"><img src="${ctx!}/web-static/assets/img/person-02.jpg" alt=""></div>
                                            </div>
                                            <h4>Peter Wood</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <a href="${ctx!}/web-static/assets/img/1.jpg" class="work image-popup">
                                ...
                                <!--end description-->
                                <div class="image">
                                    <div class="bg-transfer"><img src="${ctx!}/web-static/assets/img/1.jpg" alt=""></div>
                                </div>
                            </a>
                            <!--end work-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4 col-sm-4">
                            <a href="${ctx!}/web-static/assets/img/2.jpg" class="work image-popup">
                                <div class="description">
                                    <h4>Landscape</h4>
                                    <h5>Illustration</h5>
                                </div>
                                <!--end description-->
                                <div class="image">
                                    <div class="bg-transfer"><img src="${ctx!}/web-static/assets/img/2.jpg" alt=""></div>
                                </div>
                            </a>
                            <!--end work-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4 col-sm-4">
                            <a href="${ctx!}/web-static/assets/img/3.jpg" class="work image-popup">
                                <div class="description">
                                    <h4>Massa</h4>
                                    <h5>Logo design</h5>
                                </div>
                                <!--end description-->
                                <div class="image">
                                    <div class="bg-transfer"><img src="${ctx!}/web-static/assets/img/3.jpg" alt=""></div>
                                </div>
                            </a>
                            <!--end work-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4 col-sm-4">
                            <a href="${ctx!}/web-static/assets/img/4.jpg" class="work image-popup">
                                <div class="description">
                                    <h4>11Street</h4>
                                    <h5>Logo design</h5>
                                </div>
                                <!--end description-->
                                <div class="image">
                                    <div class="bg-transfer"><img src="${ctx!}/web-static/assets/img/4.jpg" alt=""></div>
                                </div>
                            </a>
                            <!--end work-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4 col-sm-4">
                            <a href="${ctx!}/web-static/assets/img/5.jpg" class="work image-popup">
                                <div class="description">
                                    <h4>App</h4>
                                    <h5>Branding</h5>
                                </div>
                                <!--end description-->
                                <div class="image">
                                    <div class="bg-transfer"><img src="${ctx!}/web-static/assets/img/5.jpg" alt=""></div>
                                </div>
                            </a>
                            <!--end work-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4 col-sm-4">
                            <a href="${ctx!}/web-static/assets/img/6.jpg" class="work image-popup">
                                <div class="description">
                                    <h4>Moon</h4>
                                    <h5>Photography</h5>
                                </div>
                                <!--end description-->
                                <div class="image">
                                    <div class="bg-transfer"><img src="${ctx!}/web-static/assets/img/6.jpg" alt=""></div>
                                </div>
                            </a>
                            <!--end work-->
                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <div class="box">
                                <div class="icon">
                                    <img src="${ctx!}/web-static/assets/img/camera.png" alt="">
                                </div>
                                <h3>Photography</h3>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="box">
                                <div class="icon">
                                    <img src="${ctx!}/web-static/assets/img/computer.png" alt="">
                                </div>
                                <h3>Webdesign</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus laoreet sed tellus ut condimentum</p>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="box">
                                <div class="icon">
                                    <img src="${ctx!}/web-static/assets/img/compose.png" alt="">
                                </div>
                                <h3>Copywriting</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus laoreet sed tellus ut condimentum</p>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="box">
                                <div class="icon">
                                    <img src="${ctx!}/web-static/assets/img/cloud.png" alt="">
                                </div>
                                <h3>Cloud Servers</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus laoreet sed tellus ut condimentum</p>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="box">
                                <div class="icon">
                                    <img src="${ctx!}/web-static/assets/img/mail.png" alt="">
                                </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="box">
                                <div class="icon">
                                    <img src="${ctx!}/web-static/assets/img/magnifyingglass.png" alt="">
                                </div>
...
<script  src="${ctx!}/web-static/assets/js/jquery-2.2.1.min.js"></script>
<script  src="http://ditu.google.cn/maps/api/js"></script>
<script  src="${ctx!}/web-static/assets/bootstrap/js/bootstrap.min.js"></script>
<script  src="${ctx!}/web-static/assets/js/jquery.validate.min.js"></script>
<script  src="${ctx!}/web-static/assets/js/jquery.magnific-popup.min.js"></script>
<script  src="${ctx!}/web-static/assets/js/TweenLite.min.js"></script>
<script  src="${ctx!}/web-static/assets/js/EasePack.min.js"></script>
<script  src="${ctx!}/web-static/assets/js/exploding-triangles.js"></script>
<script  src="${ctx!}/web-static/assets/js/custom.js"></script>

<script>

    var latitude = 34.038405;
    var longitude = -117.946944;
    var markerImage = "${ctx!}/web-static/assets/img/map-marker.png";
    var mapTheme = "light";
    var mapElement = "map";
