...
public class NumberUtils  extends org.apache.commons.lang.math.NumberUtils{
    ...
    public static long transformLong(Object number) {
        ...
        if (!org.apache.commons.lang.math.NumberUtils.isNumber(numberString)) {
            return 0L;
        }
    ...
    public static Long sum(List<Long> numbers) {
        if (CollectionUtils.isEmpty(numbers)) {
            return org.apache.commons.lang.math.NumberUtils.LONG_ZERO;
        }

        Long sum = 0L;
        for (Long number : numbers) {
            sum = sum + NumberUtils.transformLong(number);
        }
