...
public interface BaseService<T extends BaseModel> {
     ...
     * @return 对应实体T
     */
    T get(Long modelId, String... fieldNames);
     ...
     * @return 要获取的属性值
     */
    <V> V getFieldValueById(Long modelId, String fieldName);
     ...
     * @return 实体对象列表
     */
    List<T> listByIds(List<Long> modelIds, String... fieldNames);
     ...
     * @return 实体对象列表
     */
    List<T> listByIds(List<Long> modelIds, Order[] orders, String... fieldNames);
     ...
     */
    int update(Long modelId, String fieldName, Object value);
     ...
     *                  比如，BigDecimal类型需要如下new BigDecimal（100）
     */
    int update(List<Long> modelIds, String fieldName, Object value);
     ...
     * @return 更新条数
     */
    int update(List<Long> modelIds, T model, String... fields);
     ...
     * @return 更新条数
     */
    int incr(Long modelId, String fieldName, Object increment);
     ...
     * @return 更新条数
     */
    int incr(List<Long> modelIds, String fieldName, Object increment);
     ...
     * @return 更新条数
     */
    int incr(Long modelId, T model, String[] incrFields, String... fields);
     ...
     * @return 更新条数
     */
    int incr(List<Long> modelIds, T model, String[] incrFields, String... fields);
     ...
     * @return 保存成功的主键
     */
    List<Long> batchSave(List<T> models);
