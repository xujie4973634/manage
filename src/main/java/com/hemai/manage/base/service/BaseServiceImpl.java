package com.hemai.manage.base.service;

import com.hmaikj.applet.utils.ReflectUtils;
...
import static com.hemai.manage.base.model.BaseModel.*;
...
public class BaseServiceImpl<T extends BaseModel> implements BaseService<T>, Constant {
    ...
    public BaseServiceImpl() {
        modelClass = ReflectUtils.getGenericParamClass(this.getClass());
    }
...
//        set.add(_updateBy);
    ...
    private String processHqlMapKey(String fieldKey) {
        if (!fieldKey.contains(Constant.POINT)) {
            return fieldKey;
        }

        StringBuilder builder = new StringBuilder();
        String[] fieldSegment = fieldKey.split("\\" + Constant.POINT);
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public int update(Long modelId, String fieldName, Object value) {
        Assert.notNull(modelId, "modelId is empty!");
        Assert.hasText(fieldName, "fieldName is empty!");

        List<Long> modelIds = new ArrayList<>(1);
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public int update(List<Long> modelIds, String fieldName, Object value) {
        ...
        builder.append(_updateTime).append(EQUAL).append(COLON + _updateTime);
...
//        query.setParameter(_updateBy, ExecutionContext.getUserId());
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public int update(List<Long> modelIds, T model, String... fields) {
        Assert.notEmpty(modelIds, "modelIds is empty!");
        Assert.notNull(model, "model is null!");
    ...
    private Object getFieldValue(String fieldName, Object model) {
        ...
        if (!fieldName.contains(".")) {
            ...
            return ReflectUtils.getFieldValue(field, model);
        }
        ...
        Field field = ReflectUtils.getField(clazz, beforeField);
        Assert.notNull(field, "field[fieldName:" + beforeField + "] not in class[" + clazz + "]!");
        Object fieldValue = ReflectUtils.getFieldValue(field, model);
        if (fieldValue == null) {
            return null;
        }
    ...
    @Override
    @Transactional(readOnly = true)
    public T get(Long modelId, String... fieldNames) {
        Assert.notNull(modelId, "modelId is empty!");
    ...
    @Override
    @Transactional(readOnly = true, isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public boolean exist(Long modelId) {
        Assert.notNull(modelId, "modelId is empty!");
    ...
    private boolean validPrimaryKey(String firstField, String subField) {
        Field field = ReflectUtils.getField(modelClass, firstField);
        Assert.notNull(field, "field[" + firstField + "] not in class[" + modelClass + "]!");
        if (!subField.contains(".")) {
            Field f = ReflectUtils.getField(field.getType(), subField);
        ...
        Field secondField = ReflectUtils.getField(field.getType(), secondFieldName);
        ...
        Field thirdField = ReflectUtils.getField(secondField.getType(), thirdFieldName);
    ...
    private void setFieldValue(String fieldName, Object fieldValue, Object model) {
        ...
        if (!fieldName.contains(".")) {
            Field field = ReflectUtils.getField(clazz, fieldName);
            Assert.notNull(field, "field[fieldName:" + fieldName + "] not in class[" + clazz + "]!");
            ReflectUtils.setFieldValue(field, model, fieldValue);
            return;
        }
        ...
        Field field = ReflectUtils.getField(clazz, beforeField);
        Assert.notNull(field, "field[fieldName:" + beforeField + "] not in class[" + clazz + "]!");
        Object relModel = ReflectUtils.getFieldValue(field, model);
        if (relModel == null) {
            relModel = ReflectUtils.newInstance(field.getType());
            ReflectUtils.setFieldValue(field, model, relModel);
        }
    ...
    @Override
    @Transactional(readOnly = true, rollbackFor = RuntimeException.class)
    public <V> V getFieldValueById(Long modelId, String fieldName) {
        Assert.notNull(modelId, "modelId is empty!");
        Assert.hasText(fieldName, "fieldName is empty!");
    ...
    private T getByCriteriaAndFieldNames(Criteria criteria, String[] fieldNames) {
        ...
        T model = (T) ReflectUtils.createInstance(modelClass);
    ...
    @Override
    @Transactional(readOnly = true, rollbackFor = RuntimeException.class)
    public List<T> listByIds(List<Long> modelIds, String... fieldNames) {
        Assert.notEmpty(modelIds, "modelIds is empty!");
    ...
    @Override
    @Transactional(readOnly = true, rollbackFor = RuntimeException.class)
    public List<T> listByIds(List<Long> modelIds, Order[] orders, String... fieldNames) {
        Assert.notEmpty(modelIds, "modelIds is empty!");
        Assert.notEmpty(orders, "orders is empty!");
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public List<Long> batchSave(List<T> models) {
        Assert.notEmpty(models, "Models is empty!");
    ...
    private HqlBuilder toHqlBuilder(Criterion criterion) {
        ...
        CriteriaQuery criteriaQuery = new PmCriteriaQuery(translator);
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public int incr(Long modelId, String fieldName, Object increment) {
        Assert.notNull(modelId, "modelId is empty!");
        Assert.hasText(fieldName, "fieldName is empty!");
        Assert.notNull(increment, "increment is null!");
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public int incr(List<Long> modelIds, String fieldName, Object increment) {
        Assert.notEmpty(modelIds, "modelIds is empty!");
        Assert.hasText(fieldName, "fieldName is empty!");
        Assert.notNull(increment, "increment is null!");
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public int incr(Long modelId, T model, String[] incrFields, String... fields) {
        Assert.notNull(modelId, "modelId is empty!");
        Assert.notNull(model, "model is null!");
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, rollbackFor = RuntimeException.class)
    public int incr(List<Long> modelIds, T model, String[] incrFields, String... fields) {
